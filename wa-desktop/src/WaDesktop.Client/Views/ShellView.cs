...
namespace WaDesktop.Client.Views
{
    public partial class ShellView : Form, IShellView
    {
        ...
        public ISoftwareUpdateView CreateSoftwareUpdateView()
        {
            return new SoftwareUpdateView();
        }

        public bool ShowDialog(ISoftwareUpdateView view)
        {
        ...
        private void toolStripSoftwareUpdate_Click(object sender, EventArgs e)
            => SoftwareUpdateClicked?.Invoke(sender, e);
